...
![left2](img/left2.png)
![left3](img/left3.png)
5. （テスター頒布版のみ）ロータリーエンコーダがチャタリングを起こす場合は画像のように真ん中のピンと左右のピンをつなぐようにコンデンサを追加することでチャタリングを低減することができます。(応急処置なのではんだ付けが汚くてすみません。)10nFか22nF推奨です。本頒布版では基板に組み込むので本対応は不要です！
![left4](img/left4.jpg)
